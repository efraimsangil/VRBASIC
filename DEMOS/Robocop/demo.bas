...
_GLCALL(frases, "setclipping", "false") 'No hace nada
_GLCALL(frases,"SetText","Apatrullando la ciudad!")
_GLCALL(frases, "setpos", 100, 80)
...
@ThomasWalk:
_GLCALL(frases,"SetText","A ti te queria ver yo!")
_GLCALL(frases, "setpos", 360, 80)
FOR K=1 to 800: NEXT K : REM Espera
_GLCALL(frases,"SetText","Efra me ha traido de vuelta.")
_GLCALL(frases, "setpos", 360, 80)
FOR K=1 to 800: NEXT K : REM Espera

_GLCALL(frases,"SetText","Y ahora no tienes armas.\nTe voy a...")
_GLCALL(frases, "setpos", 360, 80)
...
FOR K=1 to 500: NEXT K : REM Espera
_GLCALL(s2, "setanimation", "quiet")
_GLCALL(frases,"SetText","Vamos!! Ahora que?")
_GLCALL(frases, "setpos", 360, 80)
FOR K=1 to 800: NEXT K : REM Espera
