...
' _GLCALL(s2, "addanimationwithsheet", "attack", "graphics/Attack1.png", 0,2,0,0,55,75, -1, -1, -1)
...
@PlayerJump:
DY=DY+1
IF _GLCALL(s2,"getY")>90 THEN _GLCALL(s2,"setY", 90):M$="quiet":GOSUB @PlayerChangeState
IF (S=3) THEN DX=2
IF (S=7) THEN DX=-2
RETURN
